<template>
  <el-main>
    <div style="width: 100%;height: 40.76vw;">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <div>
            <el-row :gutter="60" type="flex" style="margin-top: 10px">
              <el-col>
        ...
        <el-col :span="8" push="4">
          <div style="color: white; margin-top: 10px">中文</div>
        </el-col>
      </el-row>
      ...
      <el-row type="flex">
        ...
        <el-col span="8" push="6">
          <el-image :src="require('../assets/head_person.png')" style="height: 400px; width: 400px"></el-image>
        </el-col>
      </el-row>
    </div>
    <div style="height: 2738px; width: 100%; background-color: black; margin-top: -2px">
      ...
      <el-row style="height: 829px" type="flex">
        <el-col span="6" push="4">
          <div
            style="width: 100%;font-size: 18px;font-weight: 500;color: #FFFFFF;line-height: 24px; margin-top: 240px">
      ...
      <el-row type="flex">
        <el-col span="6" push="5">
          ...
          <div class="iconText" style="margin-left: 50px">
